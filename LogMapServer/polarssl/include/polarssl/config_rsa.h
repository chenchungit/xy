 ...
 * \{
 */
//#define POLARSSL_CONFIG_OPTIONS  /*phoenix added*/

//#if defined(POLARSSL_CONFIG_OPTIONS)  /*phoenix added*/
...
/* SSL options */
#define SSL_MAX_CONTENT_LEN             768 /**< Size of the input / output buffer */
