...
#else
#if !defined(EFIX64) && !defined(EFI32) && !defined(__ICCARM__) && !defined(__CC_ARM)
...
#else
    unsigned long n = (int) sizeof( client_addr );
#endif
...
{
#if ( defined(_WIN32) || defined(_WIN32_WCE) || defined(__ICCARM__) || defined(__CC_ARM)) && !defined(EFIX64) && \
    !defined(EFI32)
    unsigned long n = 0;
